...
class CatPreferencesPage extends StatefulWidget {
  const CatPreferencesPage({super.key});

  @override
  _CatPreferencesPageState createState() => _CatPreferencesPageState();
}

class _CatPreferencesPageState extends State<CatPreferencesPage> {
  int _currentStep = 0;
